  ...
  return (
    <div className="min-h-screen flex bg-background text-text-primary">
      ...
      <div className="flex-1 flex flex-col">
        {/* Header/Navbar */}
        <header className="h-20 bg-surface/30 backdrop-blur-md border-b border-border flex items-center justify-between px-10">
          ...
          <div className="flex items-center gap-6">
            <div className="text-[10px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full bg-success/10 text-success border border-success/20">
              System: Operational
            </div>
          </div>
        </header>
